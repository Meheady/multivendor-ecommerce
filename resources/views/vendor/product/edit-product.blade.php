        ...
        <div class="row">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <hr/>
                    <form action="{{ route('update.vendor.product',$product->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
        ...
        <div class="row">
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <hr/>
                    <form action="{{ route('update.vendor.product.thumb',$product->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <form action="{{ route('update.vendor.product.multimg') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @foreach($multImages as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('delete.vendor.multiimages',$item->id)}}" class="delete btn-small btn btn-danger">Del</a>
                                    </td>
                                </tr>
                            @endforeach
                        </form>
