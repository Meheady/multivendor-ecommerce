                    ...
                    <div class="card-body">
                        <form action="{{route('store.district')}}" method="post">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="text" class="form-control @error('district_name') is-invalid @enderror" name="district_name" />
                                    @error('name')
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="submit" class="btn btn-primary px-4" value="Save District" />
                                </div>
                            </div>
                        </form>
                    </div>
