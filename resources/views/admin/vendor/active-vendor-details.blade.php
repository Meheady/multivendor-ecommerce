            ...
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('update.vendor.status',$userData->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <textarea name="vendor_info" id="" class="form-control" placeholder="Write about your shop..." cols="25" rows="2">{{$userData->vendor_info}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
