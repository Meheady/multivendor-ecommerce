                ...
                <div class="col-lg-12">
                    <div class="position-relative newsletter-inner">
                        <div class="newsletter-content">
                            ...
                            <p class="mb-45">Start You'r Daily Shopping with <span class="text-brand">Online Mart</span></p>
            ...
            <div class="row">
                <div class="col">
                    <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <div class="logo mb-30">
                            <a href="{{ route('/') }}" class="mb-15"><img src="{{asset('frontend')}}/assets/imgs/theme/elogo.png" alt="logo" /></a>
                            <p class="font-lg text-heading">Best online market Mart and Grocery</p>
                        </div>
                        <ul class="contact-infor">
                            <li><img src="{{asset('frontend')}}/assets/imgs/theme/icons/icon-location.svg" alt="" /><strong>Address: </strong> <span>House #32, Banasre, Rampura Dhaka</span></li>
                            ...
                            <li><img src="{{asset('frontend')}}/assets/imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email:</strong><span>sale@emarket.com</span></li>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        ...
                        <li><a href="{{ route('all.vendor') }}">Our Vendor</a></li>
                    </ul>
                </div>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">&copy; 2023, <strong class="text-brand">e-market</strong> All rights reserved</p>
            </div>
