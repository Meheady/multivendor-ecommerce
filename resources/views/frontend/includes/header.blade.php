                                    ...
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Nest" {{asset('frontend')}}/assets/imgs/shop/thumbnail-3.jpg" /></a>
                                            </div>
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href="shop-product-right.html"><img alt="Nest" {{asset('frontend')}}/assets/imgs/shop/thumbnail-2.jpg" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
                            ...
                            <div class="header-action-icon-2">
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{route('dashboard')}}#track-orders-tab"><i class="fi fi-rs-location-alt mr-10"></i>Order Tracking</a>
                                        </li>
                                        <li>
                                ...
                                @else
                                    <a href="{{route('login')}}"><span class="lable ml-0 mr-2">Login</span></a>
                                    <span class="lable p-1">|</span>
            ...
            <div class="header-wrap header-space-between position-relative">
                    ...
                    <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                        <nav>
                            ...
                            <ul>
                                ...
                                @php
                                    $categories = App\Models\Category::orderBy('cat_name','ASC')->limit(5)->get();
                                @endphp

                                @foreach($categories as $category)
                                <li>
                                    <a href="{{ url('product/category/'.$category->id.'/'.$category->cat_slug) }}">{{ $category->cat_name }}<i class="fi-rs-angle-down"></i></a>
                                    @php
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li>
                                            <a href="{{ url('product/sub-category/'.$item->id.'/'.$item->sub_cat_slug) }}">{{ $item->sub_cat_name }}</a>
                                        </li>
                                        @endforeach
                                    </ul>
                                </li>
                ...
                <div class="header-action-right d-block d-lg-none">
                    <div class="header-action-2">
                        <div class="header-action-icon-2">
                            <a href="shop-wishlist.html">
                                <img alt="Nest" {{asset('frontend')}}/assets/imgs/theme/icons/icon-heart.svg" />
                                <span class="pro-count white">4</span>
                            </a>
                        </div>
                        <div class="header-action-icon-2">
                            <a class="mini-cart-icon" href="#">
                                <img alt="Nest" {{asset('frontend')}}/assets/imgs/theme/icons/icon-cart.svg" />
                            ...
                            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                <ul>
                                    ...
                                    <li>
                                        <div class="shopping-cart-img">
                                            <a href="shop-product-right.html"><img alt="Nest" {{asset('frontend')}}/assets/imgs/shop/thumbnail-4.jpg" /></a>
                                        </div>
                                        <div class="shopping-cart-title">
