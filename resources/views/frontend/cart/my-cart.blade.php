        ...
        <div class="row">
            <div class="col-lg-8 mb-40">
                ...
                <div class="d-flex justify-content-between">
                    <h6 class="text-body">There are <span class="text-brand cartQty">0</span> products in your cart</h6>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="col-lg-7">
                        ...
                        <div class="border p-md-4 cart-totals ml-30">
                            <div class="table-responsive">
                                <table id="amountArea" class="table no-border">
